...
import Sidebar from "./OAuth_token_form";
    ...
    <>
      <div className="fixed top-24 left-64 right-0">
        <div className="flex justify-between p-4">
          <div>
            <span className="text-lg font-semibold">OAuth Token</span>
          </div>
                      ...
                      <table className="text-left w-full border-collapse border-gray-300 mb-14">
                        <thead className="bg-gray-300 sticky top-0 z-10 text-xs">
                          <tr>
                            ...
                            <th scope="col" className="py-3 px-6">Client ID</th>
                            <th scope="col" className="py-3 px-6">Refresh Token</th>
                            <th scope="col" className="py-3 px-6">Scopes</th>
                            <th scope="col" className="py-3 px-6">Created At</th>
                            <th scope="col" className="py-3 px-6">Expires At</th>
                          ...
                          {loading ? (
                            ...
                            <tr>
                              <td colSpan="8" className="py-10 text-center">
                                <div className="flex flex-col items-center justify-center p-5">
                                  ...
                                  <p className="text-center text-lg font-normal">You don't have OAuth Token yet. Create new OAuth Token.</p>
                                  <p onClick={toggleSidebar} className="mt-3 cursor-pointer text-white bg-blue-400 px-4 py-1 rounded-md">Add Token</p>
                                </div>
                              </td>
                            </tr>
                            ...
                            currentFilteredRows.map((candidate) => (
                              <tr key={candidate._id} className="bg-white border-b cursor-pointer text-xs">
                                ...
                                <td className="py-2 px-6">{candidate.CreatedAt}</td>
